---
title: "2024-05-06-CSAPP2_信息表示与处理"
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531134513.png)
...
- 布尔运算：与、或、非、异或
- 小整数集合，是否在集合中用01表示
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531135025.png)
- 三基色模型
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531135102.png)
...
- 右移
	...
	- 算数移位
		- 左边赋值最高有效位
- 未定义行为：移位量小于0或大于等于字长
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531143419.png)
注意C语言中移位操作符优先级低于+-\*/
...
补码最高有效位是符号位
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531145753.png)

### 补码转换

- 负数的绝对值：取反加一
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240531150718.png)

### 数值范围

![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240607212317.png)
...
把符号位复制 k 位
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240607221107.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240607221840.png)

#### 截断

![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240607222434.png)

- 无符号数：$$x' = x\mod 2^k$$k为截断到的位数
- 有符号数：

![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240607222534.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608004954.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608005305.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608005450.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608010210.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608010218.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608100430.png)

#### 补码乘法

$$x * y^t_w = U2T_w((x \cdot y)\mod 2^w)$$
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608101540.png)
...
无符号数：逻辑移位后向下取整
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608111551.png)

**有符号数：** 特殊
如果跟无符号数一样直接算数移位的话，对于非负数结果没有问题，但是对于负数，这样移位后结果会向错误的方向舍入(理论上希望向0舍入，实际变成了向下舍入)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608112826.png)
解决方式：加入“偏置(bias)”
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608114200.png)
- 需要舍入的情况，通过加上$2^k - 1$，会使得第k+1位得到一个进位，从而在后面的移位时向0舍入
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608114254.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608114800.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608114815.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608120840.png)
关于字的问题：
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608121200.png)
数据表示：
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608121228.png)
...
大端法：最低有效字节在最高的地址
小端法：最低有效字节在最低的地址
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608121316.png)

IA32,X86-64是大端，Android,IOS等是小端
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240608121553.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610113432.png)
位数对应的是分母，是2的幂次，对应的二进制数是分子
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610113526.png)
但使用该方法计算得到的小数有误差，因为这样得到的数是离散的，而小数是连续的：
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610113803.png)
...
示例：单精度浮点数
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610122646.png)
但同样不是精准的
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610122727.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610124537.png)
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610124627.png)
...
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610134659.png)
...
▪ 尾数左移，阶码减1
▪ 尾数右移，阶码加1
![image.png](https://cdn.jsdelivr.net/gh/BlackJack0083/image@main/img/20240610141655.png)
